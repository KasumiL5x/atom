...
public:
	 ...
	 * @param timePrefix  If true, the time will be prefixed to the message.
	 * @param destination Method of output.
	 */
	void log( const std::string& entry, bool timePrefix=true, Destination destination=Destination::Std );
