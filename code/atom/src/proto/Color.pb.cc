...
Color::Color()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:atom.proto.Color)
}
...
Color::Color(const Color& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:atom.proto.Color)
}
...
Color::~Color() {
  // @@protoc_insertion_point(destructor:atom.proto.Color)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:atom.proto.Color)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:atom.proto.Color)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:atom.proto.Color)
  return false;
#undef DO_
}
...
void Color::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:atom.proto.Color)
  // optional float r = 1;
  if (this->r() != 0) {
  ...
  // @@protoc_insertion_point(serialize_end:atom.proto.Color)
}

::google::protobuf::uint8* Color::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:atom.proto.Color)
  // optional float r = 1;
  if (this->r() != 0) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:atom.proto.Color)
  return target;
}
