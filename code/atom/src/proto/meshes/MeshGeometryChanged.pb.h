...
#ifndef PROTOBUF_meshes_2fMeshGeometryChanged_2eproto__INCLUDED
#define PROTOBUF_meshes_2fMeshGeometryChanged_2eproto__INCLUDED
...
class MeshGeometryChanged;

// ===================================================================

class MeshGeometryChanged : public ::google::protobuf::Message {
 public:
  MeshGeometryChanged();
  virtual ~MeshGeometryChanged();

  MeshGeometryChanged(const MeshGeometryChanged& from);

  inline MeshGeometryChanged& operator=(const MeshGeometryChanged& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const MeshGeometryChanged& default_instance();

  void Swap(MeshGeometryChanged* other);

  // implements Message ----------------------------------------------

  inline MeshGeometryChanged* New() const { return New(NULL); }

  MeshGeometryChanged* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const MeshGeometryChanged& from);
  void MergeFrom(const MeshGeometryChanged& from);
  void Clear();
  ...
  void InternalSwap(MeshGeometryChanged* other);
  private:
  ...
  // @@protoc_insertion_point(class_scope:atom.proto.meshes.MeshGeometryChanged)
 private:
  ...
  friend void  protobuf_AddDesc_meshes_2fMeshGeometryChanged_2eproto();
  friend void protobuf_AssignDesc_meshes_2fMeshGeometryChanged_2eproto();
  friend void protobuf_ShutdownFile_meshes_2fMeshGeometryChanged_2eproto();

  void InitAsDefaultInstance();
  static MeshGeometryChanged* default_instance_;
};
// ===================================================================
...
// optional string MeshName = 1;
inline void MeshGeometryChanged::clear_meshname() {
  meshname_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& MeshGeometryChanged::meshname() const {
...
inline void MeshGeometryChanged::set_meshname(const ::std::string& value) {
...
inline void MeshGeometryChanged::set_meshname(const char* value) {
...
inline void MeshGeometryChanged::set_meshname(const char* value, size_t size) {
...
inline ::std::string* MeshGeometryChanged::mutable_meshname() {
...
inline ::std::string* MeshGeometryChanged::release_meshname() {
  
  return meshname_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void MeshGeometryChanged::set_allocated_meshname(::std::string* meshname) {
  if (meshname != NULL) {
...
// repeated .atom.proto.Vertex Vertices = 2;
inline int MeshGeometryChanged::vertices_size() const {
  return vertices_.size();
}
inline void MeshGeometryChanged::clear_vertices() {
  vertices_.Clear();
}
inline const ::atom::proto::Vertex& MeshGeometryChanged::vertices(int index) const {
  // @@protoc_insertion_point(field_get:atom.proto.meshes.MeshGeometryChanged.Vertices)
  return vertices_.Get(index);
}
inline ::atom::proto::Vertex* MeshGeometryChanged::mutable_vertices(int index) {
  // @@protoc_insertion_point(field_mutable:atom.proto.meshes.MeshGeometryChanged.Vertices)
  return vertices_.Mutable(index);
}
inline ::atom::proto::Vertex* MeshGeometryChanged::add_vertices() {
...
// repeated int32 Indices = 3 [packed = true];
inline int MeshGeometryChanged::indices_size() const {
  return indices_.size();
}
inline void MeshGeometryChanged::clear_indices() {
  indices_.Clear();
}
inline ::google::protobuf::int32 MeshGeometryChanged::indices(int index) const {
  // @@protoc_insertion_point(field_get:atom.proto.meshes.MeshGeometryChanged.Indices)
  return indices_.Get(index);
}
inline void MeshGeometryChanged::set_indices(int index, ::google::protobuf::int32 value) {
  indices_.Set(index, value);
  // @@protoc_insertion_point(field_set:atom.proto.meshes.MeshGeometryChanged.Indices)
}
inline void MeshGeometryChanged::add_indices(::google::protobuf::int32 value) {
  indices_.Add(value);
...
#endif  // PROTOBUF_meshes_2fMeshGeometryChanged_2eproto__INCLUDED
