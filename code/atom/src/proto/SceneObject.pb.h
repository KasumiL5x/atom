...
class SceneObject : public ::google::protobuf::Message {
 public:
  SceneObject();
  virtual ~SceneObject();
  ...
  inline SceneObject* New() const { return New(NULL); }

  SceneObject* New(::google::protobuf::Arena* arena) const;
  ...
  // @@protoc_insertion_point(class_scope:atom.proto.SceneObject)
 private:
  ...
  static SceneObject* default_instance_;
};
// ===================================================================
...
inline void SceneObject::set_name(const char* value, size_t size) {
